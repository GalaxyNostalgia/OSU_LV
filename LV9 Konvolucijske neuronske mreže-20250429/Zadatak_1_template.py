...
'''
Zadatak 9.4.1 Skripta Zadatak_1.py uˇcitava CIFAR-10 skup podataka. Ovaj skup sadrži
...
mreža?
2. Pokrenite uˇcenje mreže. Pratite proces uˇcenja pomo ́cu alata Tensorboard na sljede ́ci naˇcin.
Pokrenite Tensorboard u terminalu pomo ́cu naredbe:
tensorboard –logdir=logs
i zatim otvorite adresu http://localhost:6006/ pomo ́cu web preglednika.
